...
"create a monitor here"), plus **monitor_view** ("hide/show/toggle monitors", with
"monitor view" retained as an alias); five drive plain Hyprland window management — **focus**
